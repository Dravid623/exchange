  ...
  return (
    <Card title="">
      <div className="grid grid-cols-5 gap-4 text-sm font-medium text-gray-900 dark:text-white p-4">
        ...
        {/* 24H High */}
        <div className="flex flex-col">
          <span className="text-md text-gray-500 font-semibold">24H High</span>
          <span className="text-base font-normal">{todaysChange?.high ?? "N/A"}</span>
        </div>

        {/* 24H Low */}
        <div className="flex flex-col">
          <span className="text-md text-gray-500 font-semibold">24H Low</span>
          <span className="text-base font-normal">{todaysChange?.low ?? "N/A"}</span>
        </div>

        {/* 24H Volume */}
        <div className="flex flex-col">
          <span className="text-md text-gray-500 font-semibold">24H Volume</span>
